...
import { formatAddress, getPropertyDetails } from "@/lib/utils";
...
const ApplicationCard = ({ startDate, endDate, propertyId, status }: Lease) => {
  const { manager, property } = getPropertyDetails(propertyId);
